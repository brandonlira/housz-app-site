...
/**
 * Provides index for matching units.
 */
class MatchingUnitIndex extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    $this->derivatives[$entity_type_id]['title'] = $this->t('Calendar matching units');
    $this->derivatives[$entity_type_id]['description'] = $this->t('Index of units objects.');
    $this->derivatives[$entity_type_id]['category'] = $this->t('Calendar matching units');
